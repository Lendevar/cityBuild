...
########################
# movement
export (float, 0, 100, 0.5) var movement_speed = 40
# zoom
export (float, 0, 100, 0.5) var min_zoom = 3
export (float, 0, 100, 0.5) var max_zoom = 100
export (float, 0, 100, 0.5) var zoom_speed = 40
...
# pan
export (float, 0, 10, 0.5) var pan_speed = 7
# flags
...
export (NodePath) var currentCamera
